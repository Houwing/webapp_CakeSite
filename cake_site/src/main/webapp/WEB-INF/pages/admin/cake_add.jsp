                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-5">
                                    <label for="cakename" class="field prepend-icon">
                                        <input type="text" name="cakename" id="cakename" class="gui-input" placeholder="名称..." required>
                                            ...
                                            <c:forEach items="${root.children}" var="cat1">
                                                <c:forEach items="${cat1.children}" var="cat2">
                                                    <c:forEach items="${cat2.children}" var="cat3">
                                                        <option value="${cat3.id}">${cat1.name}->${cat2.name}->${cat3.name}</option>
                                                    </c:forEach>
                                                </c:forEach>
                                            </c:forEach>
                                        </select>
                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-2">
                                    <label for="brand" class="field prepend-icon">
                                        <input type="text" name="brand" id="brand" class="gui-input" placeholder="品牌..." required>
