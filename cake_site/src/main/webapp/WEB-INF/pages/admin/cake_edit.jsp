                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-5">
                                    <label for="cakename" class="field prepend-icon">
                                        <input type="text" name="cakename" id="cakename" class="gui-input" value="${cake.cakename}" required>
                            ...
                            <div class="section row">
                                            ...
                                            <c:forEach items="${root.children}" var="cat1">
                                                <c:forEach items="${cat1.children}" var="cat2">
                                                    <c:forEach items="${cat2.children}" var="cat3">
                                                        <c:if test="${cat3.id==cake.category}">
                                                        <option selected value="${cat3.id}">${cat1.name}->${cat2.name}->${cat3.name}</option>
                                                        </c:if>
                                                    </c:forEach>
                                                </c:forEach>
                                            </c:forEach>
                                ...
                                <div class="col-md-2">
                                    <label for="taste" class="field prepend-icon">
                                        <input type="text" name="taste" id="taste" class="gui-input" value="${cake.taste}" required>
                                ...
                                <div class="col-md-2">
                                    <label for="sweetness" class="field prepend-icon">
                                        <input type="number" name="sweetness" id="sweetness" class="gui-input" required min="1" max="5" value="${cake.sweet}">
                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-2">
                                    <label for="price" class="field prepend-icon">
                                        <input type="text" name="price" id="price" class="gui-input" value="${cake.price}" required>
                                ...
                                <div class="col-md-2">
                                    <label for="weight" class="field prepend-icon">
                                        <input type="number" name="weight" id="weight" class="gui-input" value="${cake.weight}" required>
                                ...
                                <div class="col-md-2">
                                    <label for="size" class="field prepend-icon">
                                        <input type="number" name="size" id="size" class="gui-input" value="${cake.size}" required>
                                ...
                                <div class="col-md-2">
                                    <label for="size" class="field prepend-icon">
                                        <input type="text" name="brand" id="brand" class="gui-input" value="${cake.brand}" required>
                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-8">
                                    <label for="material" class="field prepend-icon">
                                        <input type="text" name="material" id="material" class="gui-input" value="${cake.ingredients}" required>
