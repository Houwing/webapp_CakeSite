        ...
        <div class="tray tray-center">
            ...
            <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
                <div class="panel heading-border">
                    <form method="post" action="/admin/Account/add.do"  id="admin-form">
                        <div class="panel-body bg-light">
                            <div class="section row">
                                <div class="col-md-1" style="margin-top: 10px;"><b>用户名</b></div>
                                <div class="col-md-5">
                                    <label for="username" class="field prepend-icon">
                                        <input type="text" name="username" id="username" class="gui-input" placeholder="用户名..." required>
                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-2">
                                    <label for="userpass" class="field prepend-icon">
                                        <input type="password" name="userpass" id="userpass" class="gui-input" placeholder="密码..." required>
                                ...
                                <div class="col-md-2">
                                    <label for="nickname" class="field prepend-icon">
                                        <input type="text" name="nickname" id="nickname" class="gui-input" placeholder="昵称..." required >
