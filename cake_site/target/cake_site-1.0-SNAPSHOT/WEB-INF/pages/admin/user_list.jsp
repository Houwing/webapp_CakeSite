                    ...
                    <div class="panel-menu">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-9 text-right">
                                <form action="/admin/User/list.do" method="post">
                        ...
                        <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                            ...
                            <c:forEach items="${pageInfo.list}" var="account">
                                <tr class="message-unread">
                                    ...
                                    <td>
                                        <c:if test="${account.lock==true}">
                                            <a href="/admin/User/unlock.do?id=${account.id}">解锁</a>
                                        </c:if>
                                        <c:if test="${account.lock==false}">
                                            <a href="/admin/User/lock.do?id=${account.id}">锁定</a>
                                        </c:if>
                                        <a href="/admin/User/delete.do?id=${account.id}">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
